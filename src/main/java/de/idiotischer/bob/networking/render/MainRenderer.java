package de.idiotischer.bob.networking.render;

import de.idiotischer.bob.networking.BOB;
import de.idiotischer.bob.networking.map.FloodFill;
...
public class MainRenderer extends Thread {
    ...
    private void handleTileClick(int x, int y) {
        ...
        if (x > 0 && y > 0 && x < map.getWidth() && y < map.getHeight()) {
            ...
            de.idiotischer.bob.networking.state.State state = BOB.getInstance().getStateManager().getStateAt(x,y);
