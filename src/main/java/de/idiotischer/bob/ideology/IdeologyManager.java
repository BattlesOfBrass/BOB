...
public class IdeologyManager implements IdeologyResolver{
    ...
    @Override
    public Ideology byAbbreviation(String s) {
        return ideologies.stream().filter(i -> i.abbreviation().equals(s)).findFirst().orElse(null);
    }
}
